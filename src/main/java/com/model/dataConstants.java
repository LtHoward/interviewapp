...
public final class dataConstants {
    ...
    public static final String CURRENT_CLASSES = "currentClasses";
    ...
    public static final String EQUIPPED_TITLE = "equippedTitle";
    public static final String UNLOCKED_TITLES = "unlockedTitles";
    ...
    public static final String SOLUTION_NUMBER = "solutionNumber";
